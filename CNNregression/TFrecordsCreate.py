...
def read_image(filename, resize_height, resize_width, normalization=False):
    ...
    if len(bgr_image.shape) == 3:  # 若是彩色图图则调整为RGB
...
def get_batch_images(images, labels, batch_size, labels_nums=15, one_hot=False, shuffle=False, num_threads=1):
    '''
    :param images:图像
    :param labels:标签
    :param batch_size:
...
if __name__ == '__main__':
    ...
    log = 100
    # 产生train.record文件
    image_dir = 'E:/ZJU study/training_data/ExampleImage/Frontal_Images_ZIP'
    train_labels = 'E:/ZJU study/training_data/Erecords/train_list.txt'  # 标签路径
    train_record_output = 'E:/ZJU study/training_data/Erecords/train.tfrecords'
    ...
    '''
    # 产生val.record文件
    #image_dir = 'D:/Pycharm/TFRecords1/images'
    val_labels = 'D:/Pycharm/TFRecords1/train.txt'  # 图片路径
    val_record_output = 'D:/Pycharm/TFRecords1/record/train.tfrecords'
